...
class Page extends React.Component {
    ...
    componentDidMount () {
        ...
        var textSet = [
            {text:"HOLAEVER", sphereRadius:140, sphereSpace:90, unitTime:100, time:2500},
            {text:"MAKE", sphereRadius:120, sphereSpace:90, unitTime:120, time:4000},
            {text:"GOOD", sphereRadius:120, sphereSpace:90, unitTime:120, time:4000},
            {text:"SHIT", sphereRadius:120, sphereSpace:90, unitTime:120, time:4000},
            {text:"!!!!!!", sphereRadius:120, sphereSpace:90, unitTime:120, time:4000}
        ];
    ...
    render() {
        return (
            <div>
                <canvas ref='cvs' style={{position: 'absolute', top: 0, left: 0}}></canvas>
