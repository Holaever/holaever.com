...
var Page = function (_React$Component) {
    ...
    _createClass(Page, [{
        ...
        value: function componentDidMount() {
            ...
            var textSet = [{ text: "HOLAEVER", sphereRadius: 140, sphereSpace: 90, unitTime: 100, time: 2500 }, { text: "MAKE", sphereRadius: 120, sphereSpace: 90, unitTime: 120, time: 4000 }, { text: "GOOD", sphereRadius: 120, sphereSpace: 90, unitTime: 120, time: 4000 }, { text: "SHIT", sphereRadius: 120, sphereSpace: 90, unitTime: 120, time: 4000 }, { text: "!!!!!!", sphereRadius: 120, sphereSpace: 90, unitTime: 120, time: 4000 }];
        ...
        value: function render() {
            return React.createElement(
                'div',
                null,
                React.createElement('canvas', { ref: 'cvs', style: { position: 'absolute', top: 0, left: 0 } }),
                React.createElement('div', { id: 'buffer', style: { display: 'none' } })
            );
        }
    }]);
